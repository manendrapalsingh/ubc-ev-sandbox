...
# Producer: Publishes discover-connector-spec message to RabbitMQ
...
publish_message "bap.discover" "${EXAMPLE_DIR}/discover-connector-spec.json" "Discover by connector spec"
