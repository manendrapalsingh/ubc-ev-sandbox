...
# Producer: Publishes discover-vehicle-spec message to RabbitMQ
...
publish_message "bap.discover" "${EXAMPLE_DIR}/discover-vehicle-spec.json" "Discover by vehicle spec"
