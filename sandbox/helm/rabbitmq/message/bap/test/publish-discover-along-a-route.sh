...
# Producer: Publishes discover-along-a-route message to RabbitMQ
...
publish_message "bap.discover" "${EXAMPLE_DIR}/discover-along-a-route.json" "Discover along a route"
