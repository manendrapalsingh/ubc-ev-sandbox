...
helm install onix-bap ./helm/api/monolithic -f ./helm/api/monolithic/values-bap.yaml
...
```bash
# Install with default values
helm install onix-bpp ./helm/api/monolithic -f ./helm/api/monolithic/values-bpp.yaml
...
```bash
helm install onix-bap ./helm/api/monolithic \
